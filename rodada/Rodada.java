páckage br.edu.iff.bancodepalavras.dominio.rodada;
...
public class Rodada {
    ...
    public Rodada(long id, Palavra[] palavras, Jogador jogador) {
        ...
        // No construtor, em uma implementação completa, pode-se instanciar itens utilizando bonecoFactory
    }
     ...
     * Em uma implementação completa, é possível atualizar também a pontuação total do Jogador.
     *
...
// System.out.println(rodada); // Exibe: Rodada [id=1, nome=Rodada 1, pontuacao=20, jogador=Jogador 1]
// System.out.println("Pontuação atual: " + rodada.getPontuacao()); // Exibe: Pontuação atual: 20
// System.out.println("Palavras na rodada: ");
// for (Palavra p : palavras) {
//     System.out.println(p); // Exibe: Palavra [id=1, palavra=cachorro, tema=ANIMAIS]
//     System.out.println(p); // Exibe: Palavra [id=2, palavra=gato, tema=ANIMAIS]
// }
// System.out.println("Jogador: " + jogador); // Exibe: Jogador [id=1, nome=Jogador 1]
// System.out.println("ID do jogador: " + jogador.getId()); // Exibe: ID do jogador: 1
// System.out.println("Nome do jogador: " + jogador.getNome()); // Exibe: Nome do jogador: Jogador 1
// System.out.println("ID da rodada: " + rodada.getId()); // Exibe: ID da rodada: 1
// System.out.println("Nome da rodada: " + rodada.getNome()); // Exibe: Nome da rodada: Rodada 1
// System.out.println("Pontuação da rodada: " + rodada.getPontuacao()); // Exibe: Pontuação da rodada: 20
// System.out.println("Palavras na rodada: ");
// for (Palavra p : palavras) {
//     System.out.println(p); // Exibe: Palavra [id=1, palavra=cachorro, tema=ANIMAIS]
//     System.out.println(p); // Exibe: Palavra [id=2, palavra=gato, tema=ANIMAIS]
